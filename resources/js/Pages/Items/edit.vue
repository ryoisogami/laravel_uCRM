                            ...
                            <div class="flex flex-wrap -m-2">
                              ...
                              <div class="p-2 w-full">
                                <div class="relative">
                                  ...
                                  <input type="radio" id="is_selling" value="1" name="is_selling" v-model="form.is_selling" >
                                  <label class="ml-2 mr-4">販売中</label>
                                  <input type="radio" id="is_selling" value="0" name="is_selling" v-model="form.is_selling" >
                                  <label class="ml-2 mr-4">販売停止中</label>
                                </div>
                              </div>

                              <div class="p-2 w-full">
                                <button class="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">登録情報を更新する</button>
                              </div>
